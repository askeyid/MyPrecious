...
namespace MyPrecious.AT.Selenium.Helpers
{
    public static class ExpectedConditions
    {
        ...
        public static Func<IWebDriver, bool> TitleIs(string title)
        {
            return (driver) =>
            {
                var state = driver.Title;
                WriteLog.ElementDiagnostic($"Expected Wait Conditions for TitleIs {WriteLog.NewLine()}Actual: {state} {WriteLog.NewLine()}Expected: {title} {WriteLog.NewLine()}");
                return state == title;
            };
        }
        ...
        public static Func<IWebDriver, bool> TitleContains(string title)
        {
            ...
            {
                var state = driver.Title;
                WriteLog.ElementDiagnostic($"Expected Wait Conditions for TitleContains {WriteLog.NewLine()}Actual: {state} {WriteLog.NewLine()}Expected: {title} {WriteLog.NewLine()}");
        ...
        /// <returns>The <see cref="HtmlElement"/> once it is located.</returns>
        public static Func<IWebDriver, HtmlElement> ElementExists(By locator)
        {
            return (driver) => new HtmlElement(driver.FindElement(locator));
        }
        ...
        public static Func<IWebDriver, List<HtmlElement>> VisibilityOfAllElementsLocatedBy(By locator)
        {
            return (driver) =>
            {
                try
                {
                    var elements = driver.FindElements(locator).Select(x => new HtmlElement(x)).ToList();
        ...
        /// <returns>The list of <see cref="IWebElement"/> once it is located and visible.</returns>
        public static Func<IWebDriver, List<HtmlElement>> VisibilityOfAllElementsLocatedBy(List<HtmlElement> elements)
        {
            return (driver) =>
            {
                try
        ...
        public static Func<IWebDriver, List<HtmlElement>> PresenceOfAllElementsLocatedBy(By locator)
        {
            return (driver) =>
            {
                try
        ...
        public static Func<IWebDriver, bool> TextToBePresentInElement(HtmlElement element, string text)
        {
            return (driver) =>
            {
                try
        ...
        /// <param name="text">Text to be present in the element</param>
        /// <returns><see langword="true"/> once the element contains the given text; otherwise, <see langword="false"/>.</returns>
        public static Func<IWebDriver, bool> TextToBePresentInElementValue(HtmlElement element, string text)
        {
            return (driver) =>
            {
                try
        ...
        public static Func<IWebDriver, bool> StalenessOf(HtmlElement element)
        {
            return (driver) =>
            {
                try
        ...
        public static Func<IWebDriver, bool> ElementToBeSelected(HtmlElement element)
        {
        ...
        public static Func<IWebDriver, bool> ElementSelectionStateToBe(HtmlElement element, bool selected)
        {
            return (driver) =>
            {
        ...
        public static Func<IWebDriver, bool> PageLoadIsComplete()
        {
            return (driver) => JsExecutor.ExecuteScript("return document.readyState").Equals("complete");
        }
    }
}
